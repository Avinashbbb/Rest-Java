...
@Service
    ...
    @Autowired
    public InterventionServices(InterventionRepository interventionRepository) {this.interventionRepository = interventionRepository;}

    public List<Intervention> getAllIntervention(){return interventionRepository.findAll();}

    public Optional<Intervention> findById(int id) {return interventionRepository.findById(id);}
    }
